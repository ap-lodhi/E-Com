...
export const Grocery = () => {
    ...
    const handleSort = (value) => {
        ...
        axios({
            method: "get",
            url: `http://localhost:8000/products?category_like=grocery?_page=${page}&_limit=12&_sort=rating&_order=${value}`
        }).then((res) => {
    ...
    useEffect(() => {
        ...
        axios({
            method: "get",
            url: `http://localhost:8000/products?category_like=grocery`
        }).then((res) => {
            setProducts(res.data);
            setLoad(false);
